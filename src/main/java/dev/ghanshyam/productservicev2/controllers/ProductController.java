...
public class ProductController {
    ...
    */
    ...
    public ResponseEntity<Page<ProductDto>> searchby(
            ...
            @RequestParam(defaultValue = "productId") String sortby) // this RequestParam named sortby here has to match the Product attributes in class not in database. Database query will be automatically generated by JPA. We have to take care that no class attribute is having underscore like product_id , becoz then the spring will not consider it in mapping RequestParam product_id was giving error - Product has no attribute 'product'. So _ will be treated as special character and after that the result will be clipped
    {
